        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // حقل إدخال التعليق مع شروط الطول
              TextFormField(
                decoration: InputDecoration(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    ...
                    return 'Le commentaire ne doit pas dépasser 60 caractères';
                  }
                  return null;
                },
                onSaved: (value) {
              ...
              // زر إرسال النموذج مع التحقق من البيانات
              Center(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text('Merci pour avoir donné votre avis ! Note : $note/5'),
                        ),
                      );
                    }
                  },
